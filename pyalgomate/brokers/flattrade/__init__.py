...
from NorenRestApi_Flattrade.NorenApi_Flattrade import NorenApi_Flattrade as FlattradeApi
import time
...
def getScriptMaster(scripMasterFile='flattrade_symbols.csv') -> pd.DataFrame:
...
def getApi(cred):
    api = FlattradeApi(host='https://piconnect.flattrade.in/PiConnectTP/',
